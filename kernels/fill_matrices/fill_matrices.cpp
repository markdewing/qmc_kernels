...
// Compute overlap and hamiltonian matrices from parameter derivative data stored
// in *.param_deriv.h5 files
// And optionally compare the results with the matrices stored in *.linear_matrices.h5
